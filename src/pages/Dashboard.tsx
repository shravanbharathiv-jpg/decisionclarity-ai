          ...
          <div className="md:hidden flex items-center gap-2">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-48">
                ...
                {!hasPaid && <DropdownMenuItem onClick={() => navigate('/pricing')}><CreditCard className="h-4 w-4 mr-2" />Upgrade</DropdownMenuItem>}
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="md:col-span-2 space-y-6">
            <div className="text-center space-y-2">
              ...
              <p className="text-sm md:text-base text-muted-foreground">Take your time. Each decision deserves your full attention.</p>
            </div>
              ...
              <Card className="border-primary/30 bg-primary/5">
                <CardContent className="py-4">
                  <p className="text-sm text-foreground">
                    ...
                    <button onClick={() => navigate(`/reflect/${pendingReflections[0].id}`)} className="text-primary underline underline-offset-2">Start reflection</button>
                  </p>
                </CardContent>
              </Card>
            )}
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <Button onClick={() => navigate('/decision/new')} size="lg" className="gap-2"><Plus className="h-5 w-5" />New decision</Button>
              <Button onClick={() => navigate('/decision/new?mode=quick')} variant="outline" size="lg" className="gap-2"><Zap className="h-5 w-5" />Quick decision</Button>
              {hasPaid && completedDecisions.length >= 2 && (
                <Button variant="outline" onClick={() => navigate('/compare')} size="lg" className="gap-2"><GitCompare className="h-5 w-5" />Compare</Button>
              )}
            </div>
            ...
            {filteredDecisions.length > 0 ? (
              ...
              <Card className="border-dashed border-border/50">
                <CardContent className="py-12 text-center">
                  <p className="text-muted-foreground">{filter === 'all' ? 'No decisions yet. Start your first one when you are ready.' : 'No decisions in this category.'}</p>
                </CardContent>
              </Card>
            )}
          </div>
